...
def sysInclude():
    try:
        ...
        compiler_include_path = [ 
            r'c:\TCC\Tools\greenhills_ifx\comp_201815_1fp_WIN64\scxx',
            r'c:\TCC\Tools\greenhills_ifx\comp_201815_1fp_WIN64\include\tri',
            r'c:\TCC\Tools\greenhills_ifx\comp_201815_1fp_WIN64\ansi'
        ]
        stub_include_path = [
